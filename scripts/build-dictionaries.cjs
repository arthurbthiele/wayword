...
const disconnectedValidContent =
  "// Generated by scripts/build-dictionaries.cjs — do not edit by hand.\n" +
  "// Words that are valid English (per SCOWL ≤ tier " +
  DISCONNECTED_VALID_MAX_TIER +
  ") but aren't in\n" +
  "// the current playable wordGraph. Used only for friendlier rejection\n" +
  "// messages — typing one of these still fails, just with 'valid word, but\n" +
  "// not in our dictionary' rather than 'not a word'. Excludes slurs.\n" +
